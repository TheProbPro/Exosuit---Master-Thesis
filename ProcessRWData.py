...
# BasePath = Path("Outputs/IEEE/")
BasePath = Path("Outputs/RWExosuitResults/")

# Save Path
SavePath = Path(BasePath / "Processed/")
...
subsubsubfolders = ["NonePeriodic", "FullMovement"]
        ...
        for file in Files:
            for subfolder in Subfolders:
                ...
                for subsubsubfolder in subsubsubfolders:
                    ...
                    input_file = BasePath / subfolder / username / subsubsubfolder / file
                    ...
                    output_file = SavePath / subfolder / username / subsubsubfolder / file
