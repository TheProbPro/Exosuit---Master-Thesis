...
from Optimizations import EMG_IMU_optimizer, EMG_IMU_optimizer_2
    ...
    for mocap_file, emg_file, imu_file, calib_file in zip(INPUT_MOCAP_DATA, INPUT_EMG_DATA, INPUT_IMU_DATA, INPUT_IMU_CALIBRATION_DATA):
        ...
        for optimizer in IMU_OPTIMIZERS:
            for pred_model in PREDICTION_MODELS:
                ...
                if optimizer != "None":
                    optimized_angle_before.append(q)

                for filtered_net_a, imu in zip(emg_a_aligned, imu_y):
                    if optimizer == "EMG_IMU_optimizer":
                        ...
                        optimized_angle_before.append(q_next)
                ...
                if optimizer != "None":
                    optimized_angle_before.remove(optimized_angle_before[0])  # remove initial value to align with timestamps
                ...
                # TODO: Update Statistics if needed
