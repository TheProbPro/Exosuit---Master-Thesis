        ...
        for subfolder in subfolders:
            ...
            for subsubsubfolder in subsubsubfolders:
                for username in usernames:
                    file_path = folder / subfolder / username / subsubsubfolder / filename
                    if file_path.exists():
                        n_files += 1
                ...
                average_df.to_csv(folder / f"Average_{Path(filename).stem}_{subfolder}_{subsubsubfolder}_Data.csv", index=False)
