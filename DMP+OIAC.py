...
if __name__ == "__main__":
    ...
    # DMP
    dmp = pDMP(DOF, N, alpha, beta, lambd, dt = dt)
    ...
    for i in range ( samples ):
        ...
        dmp.set_phase( np.array([phi,phi,phi,phi]) )
        dmp.set_period( np.array([tau,tau,tau,tau]) )
    ...
    i = 0
    OIAC = ada_imp_con(DOF) # 1 degree of freedom
