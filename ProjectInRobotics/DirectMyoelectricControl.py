...
if __name__ == "__main__":
    ...
    print("Press enter to run pure myoelectric control for 10 seconds...")
    input()
    last_time = time.time()
    ...
    try:
        while not stop_event.is_set():
                ...
                desired_angle_deg = np.clip(desired_angle_deg, 0.0, 140.0)

                # TODO: Need to convert desired angle degree to motor steps
                new_motor_pos = MOTOR_POS_MIN - (desired_angle_deg * step)
